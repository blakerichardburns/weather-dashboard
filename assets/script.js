...
searchButton.addEventListener("click", function(event) {
    ...
    .then(function (data) {
        ...
        .then(function (data) {
            ...
            todayTempDislay.textContent = "Today's Temp: " + todayTemp + "° Fahrenheit"
            future1TempTempDislay.textContent = "Temp: " + futureOneTemp + "°F"
            future2TempTempDislay.textContent = "Temp: " + futureTwoTemp + "°F"
            future3TempTempDislay.textContent = "Temp: " + futureThreeTemp + "°F"
            future4TempTempDislay.textContent = "Temp: " + futureFourTemp + "°F"
            future5TempTempDislay.textContent = "Temp: " + futureFiveTemp + "°F"
